                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                          ...
                          @endif
                            <a href="{{url('sliders-add')}}" class="btn btn-primary py-2 px-5 btn-set-task w-sm-100"><i class="icofont-plus-circle me-2 fs-6"></i> Add Slide</a>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                                ...
                                <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <td> @if ($item->status==1)
                                            <a href="{{url('/desactiver_slider/'.$item->id)}}"><button class="btn btn-outline-warning" >
                                                <span class="badge bg-warning">Published</span></button></a>
                                              
                                            @else
                                            <a href="{{url('/activer_slider/'.$item->id)}}"><button class="btn btn-outline-danger" >
                                            <label class="badge bg-danger">desactive</label></button></a>
                                            @endif
                                         </td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                <a href="{{url('/edit_slider/'.$item->id)}}" class="btn btn-outline-success"><i class="icofont-edit text-success"></i></a>
                                                
                                                {{-- <a href="{{url('/edit_slider/'.$item->id)}}" id="delete" class=" r "><button type="button" class="btn btn-outline-secondary deleterow"><i class="icofont-ui-delete text-danger"></i></button></a> --}}
                                                {{-- <a href="{{url('/edit_slider/'.$item->id)}}" id="delete" class=" r "><i class="icofont-edit text-success"></i></a> --}}
                                                <a href="{{url('/deleteslider/'.$item->id)}}" id="delete" class=" r "><button type="button" class="btn btn-outline-banger deleterow"><i class="icofont-ui-delete text-danger"></i></button></a>
                                            </div>
                                        </td> 
                                    </tr>
